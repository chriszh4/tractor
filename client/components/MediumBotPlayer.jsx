...
export default function MediumBotPlayer({ socket, roomName, botName }) {
  ...
  useEffect(() => {
    console.log(
      `[${myName}] Medium BotPlayer component mounted with id ${socket.id}`
    );
    //const socket = io(
    ...
    return () => {
      console.log(`[${myName}] Medium BotPlayer component unmounted`);
